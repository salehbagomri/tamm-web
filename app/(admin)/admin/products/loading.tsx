  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ padding: '1rem 1.25rem', backgroundColor: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: '14px', marginBottom: '1.25rem', display: 'flex', gap: '0.75rem' }}>
        <Skel w="200px" h="2.25rem" r="10px" />
        <Skel w="150px" h="2.25rem" r="10px" />
      </div>
      <div style={{ backgroundColor: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: '16px', overflow: 'hidden' }}>
        <div style={{ padding: '1rem 1.5rem', borderBottom: '1px solid var(--border)' }}><Skel w="80px" h="1rem" /></div>
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} style={{ padding: '0.875rem 1.5rem', borderTop: '1px solid var(--border)', display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <Skel w="48px" h="48px" r="10px" />
